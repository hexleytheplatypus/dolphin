...
//            else
        ...
        (ControllerEmu::Extension*)wm->GetWiimoteGroup(WiimoteGroup::Attachments);
...
//extern WindowSystemInfo wsi;
//
//namespace OPENEMUCORE
//{
//    namespace Input
//    {
//        //static OE_input_poll_t poll_cb;
//        static OE_input_state_t input_cb;
//        //struct OE_rumble_interface rumble;
//        static const std::string source = "OPENEMUCORE";
//        static unsigned input_types[4];
//
//        static struct OE_input_descriptor descGC[] = {
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_LEFT, "Left"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_UP, "Up"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_DOWN, "Down"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_RIGHT, "Right"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_B, "B"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_A, "A"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_X, "X"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_Y, "Y"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_L2, "L"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_R2, "R"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_R, "Z"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_START, "Start"},
//            {0, OE_DEVICE_ANALOG, OE_DEVICE_INDEX_ANALOG_LEFT, OE_DEVICE_ID_ANALOG_X,
//                "Control Stick X"},
//            {0, OE_DEVICE_ANALOG, OE_DEVICE_INDEX_ANALOG_LEFT, OE_DEVICE_ID_ANALOG_Y,
//                "Control Stick Y"},
//            {0, OE_DEVICE_ANALOG, OE_DEVICE_INDEX_ANALOG_RIGHT, OE_DEVICE_ID_ANALOG_X,
//                "C Buttons X"},
//            {0, OE_DEVICE_ANALOG, OE_DEVICE_INDEX_ANALOG_RIGHT, OE_DEVICE_ID_ANALOG_Y,
//                "C Buttons Y"},
//            {0},
//        };
//
//        static struct OE_input_descriptor descWiimoteCC[] = {
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_LEFT, "Left"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_UP, "Up"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_DOWN, "Down"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_RIGHT, "Right"},
...
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_L2, "L"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_R2, "R"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_L, "ZL"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_R, "ZR"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_R3, "Home"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_START, "+"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_SELECT, "-"},
//            {0, OE_DEVICE_ANALOG, OE_DEVICE_INDEX_ANALOG_LEFT, OE_DEVICE_ID_ANALOG_X,
//                "Left Stick X"},
//            {0, OE_DEVICE_ANALOG, OE_DEVICE_INDEX_ANALOG_LEFT, OE_DEVICE_ID_ANALOG_Y,
//                "Left Stick Y"},
...
//        };
//
//        static struct OE_input_descriptor descWiimote[] = {
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_LEFT, "Left"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_UP, "Up"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_DOWN, "Down"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_RIGHT, "Right"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_B, "B"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_A, "A"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_X, "1"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_Y, "2"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_R2, "Shake Wiimote"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_START, "+"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_SELECT, "-"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_R3, "Home"},
//            {0, OE_DEVICE_ANALOG, OE_DEVICE_INDEX_ANALOG_LEFT, OE_DEVICE_ID_ANALOG_X,
...
//        };
//
//        static struct OE_input_descriptor descWiimoteSideways[] = {
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_LEFT, "Up"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_UP, "Right"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_DOWN, "Left"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_RIGHT, "Down"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_B, "1"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_A, "2"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_X, "A"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_Y, "B"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_R2, "Shake Wiimote"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_START, "+"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_SELECT, "-"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_R3, "Home"},
...
//        };
//
//        static struct OE_input_descriptor descWiimoteNunchuk[] = {
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_LEFT, "Left"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_UP, "Up"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_DOWN, "Down"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_RIGHT, "Right"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_B, "B"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_A, "A"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_X, "C"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_Y, "Z"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_L, "-"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_R, "+"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_R2, "Shake Wiimote"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_L2, "Shake Nunchuk"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_START, "1"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_SELECT, "2"},
//            {0, OE_DEVICE_JOYPAD, 0, OE_DEVICE_ID_JOYPAD_R3, "Home"},
//            {0, OE_DEVICE_ANALOG, OE_DEVICE_INDEX_ANALOG_LEFT, OE_DEVICE_ID_ANALOG_X,
//                "Nunchuk Stick X"},
//            {0, OE_DEVICE_ANALOG, OE_DEVICE_INDEX_ANALOG_LEFT, OE_DEVICE_ID_ANALOG_Y,
...
//            switch (device)
//            {
//                case OE_DEVICE_JOYPAD:
//                    return "Joypad";
//                case OE_DEVICE_ANALOG:
//                    return "Analog";
//                case OE_DEVICE_MOUSE:
//                    return "Mouse";
//                case OE_DEVICE_POINTER:
//                    return "Pointer";
//                case OE_DEVICE_KEYBOARD:
//                    return "Keyboard";
//                case OE_DEVICE_LIGHTGUN:
//                    return "Lightgun";
//            }
//            return "Unknown";
//        }
...
//                    uint16_t str = std::min(std::max(0.0, state), 1.0) * 0xFFFF;
//
//                   // rumble.set_rumble_state(m_port, OE_RUMBLE_WEAK, str);
//                   // rumble.set_rumble_state(m_port, OE_RUMBLE_STRONG, str);
//                }
//
//            private:
//                const u8 m_port;
...
//            {
//                case OE_DEVICE_JOYPAD:
//                    AddButton(OE_DEVICE_ID_JOYPAD_B, "B");
//                    AddButton(OE_DEVICE_ID_JOYPAD_Y, "Y");
//                    AddButton(OE_DEVICE_ID_JOYPAD_SELECT, "Select");
//                    AddButton(OE_DEVICE_ID_JOYPAD_START, "Start");
//                    AddButton(OE_DEVICE_ID_JOYPAD_UP, "Up");
//                    AddButton(OE_DEVICE_ID_JOYPAD_DOWN, "Down");
//                    AddButton(OE_DEVICE_ID_JOYPAD_LEFT, "Left");
//                    AddButton(OE_DEVICE_ID_JOYPAD_RIGHT, "Right");
//                    AddButton(OE_DEVICE_ID_JOYPAD_A, "A");
//                    AddButton(OE_DEVICE_ID_JOYPAD_X, "X");
//                    AddButton(OE_DEVICE_ID_JOYPAD_L, "L");
//                    AddButton(OE_DEVICE_ID_JOYPAD_R, "R");
//                    AddButton(OE_DEVICE_ID_JOYPAD_L2, "L2");
//                    AddButton(OE_DEVICE_ID_JOYPAD_R2, "R2");
//                    AddButton(OE_DEVICE_ID_JOYPAD_L3, "L3");
//                    AddButton(OE_DEVICE_ID_JOYPAD_R3, "R3");
//                    AddMotor();
//                    return;
//                case OE_DEVICE_ANALOG:
//                    AddAxis(OE_DEVICE_ID_ANALOG_X, -0x8000, "X0-", OE_DEVICE_INDEX_ANALOG_LEFT);
//                    AddAxis(OE_DEVICE_ID_ANALOG_X, 0x7FFF, "X0+", OE_DEVICE_INDEX_ANALOG_LEFT);
//                    AddAxis(OE_DEVICE_ID_ANALOG_Y, -0x8000, "Y0-", OE_DEVICE_INDEX_ANALOG_LEFT);
//                    AddAxis(OE_DEVICE_ID_ANALOG_Y, 0x7FFF, "Y0+", OE_DEVICE_INDEX_ANALOG_LEFT);
//                    AddAxis(OE_DEVICE_ID_ANALOG_X, -0x8000, "X1-", OE_DEVICE_INDEX_ANALOG_RIGHT);
//                    AddAxis(OE_DEVICE_ID_ANALOG_X, 0x7FFF, "X1+", OE_DEVICE_INDEX_ANALOG_RIGHT);
//                    AddAxis(OE_DEVICE_ID_ANALOG_Y, -0x8000, "Y1-", OE_DEVICE_INDEX_ANALOG_RIGHT);
//                    AddAxis(OE_DEVICE_ID_ANALOG_Y, 0x7FFF, "Y1+", OE_DEVICE_INDEX_ANALOG_RIGHT);
//                    AddAxis(OE_DEVICE_ID_JOYPAD_L2, 0x7FFF, "Trigger0+", OE_DEVICE_INDEX_ANALOG_BUTTON);
//                    AddAxis(OE_DEVICE_ID_JOYPAD_R2, 0x7FFF, "Trigger1+", OE_DEVICE_INDEX_ANALOG_BUTTON);
//                    return;
//                case OE_DEVICE_MOUSE:
//                    // TODO: handle last poll_cb relative coordinates correctly.
//                    AddAxis(OE_DEVICE_ID_MOUSE_X, -0x8000, "X-");
//                    AddAxis(OE_DEVICE_ID_MOUSE_X, 0x7FFF, "X+");
//                    AddAxis(OE_DEVICE_ID_MOUSE_Y, -0x8000, "Y-");
//                    AddAxis(OE_DEVICE_ID_MOUSE_Y, 0x7FFF, "Y+");
//                    AddButton(OE_DEVICE_ID_MOUSE_LEFT, "Left");
//                    AddButton(OE_DEVICE_ID_MOUSE_RIGHT, "Right");
//                    AddButton(OE_DEVICE_ID_MOUSE_WHEELUP, "WheelUp");
//                    AddButton(OE_DEVICE_ID_MOUSE_WHEELDOWN, "WheelDown");
//                    AddButton(OE_DEVICE_ID_MOUSE_MIDDLE, "Middle");
//                    AddButton(OE_DEVICE_ID_MOUSE_HORIZ_WHEELUP, "HorizWheelUp");
//                    AddButton(OE_DEVICE_ID_MOUSE_HORIZ_WHEELDOWN, "HorizWheelDown");
//                    AddButton(OE_DEVICE_ID_MOUSE_BUTTON_4, "Button4");
//                    AddButton(OE_DEVICE_ID_MOUSE_BUTTON_5, "Button5");
//                    return;
//                case OE_DEVICE_POINTER:
//                    AddButton(OE_DEVICE_ID_POINTER_PRESSED, "Pressed0", 0);
//                    AddAxis(OE_DEVICE_ID_POINTER_X, -0x8000, "X0-", 0);
//                    AddAxis(OE_DEVICE_ID_POINTER_X, 0x7FFF, "X0+", 0);
//                    AddAxis(OE_DEVICE_ID_POINTER_Y, -0x8000, "Y0-", 0);
//                    AddAxis(OE_DEVICE_ID_POINTER_Y, 0x7FFF, "Y0+", 0);
//                    return;
//                case OE_DEVICE_KEYBOARD:
//                    return;
//                case OE_DEVICE_LIGHTGUN:
//                    // TODO: handle absolute coordinates correctly.
//                    AddAxis(OE_DEVICE_ID_LIGHTGUN_SCREEN_X, -320, "X-");
//                    AddAxis(OE_DEVICE_ID_LIGHTGUN_SCREEN_X, 320, "X+");
//                    AddAxis(OE_DEVICE_ID_LIGHTGUN_SCREEN_Y, -264, "Y-");
//                    AddAxis(OE_DEVICE_ID_LIGHTGUN_SCREEN_Y, 264, "Y+");
//                    AddButton(OE_DEVICE_ID_LIGHTGUN_IS_OFFSCREEN, "Offscreen");
//                    AddButton(OE_DEVICE_ID_LIGHTGUN_TRIGGER, "Trigger");
//                    AddButton(OE_DEVICE_ID_LIGHTGUN_RELOAD, "Reload");
//                    AddButton(OE_DEVICE_ID_LIGHTGUN_AUX_A, "A");
//                    AddButton(OE_DEVICE_ID_LIGHTGUN_AUX_B, "B");
//                    AddButton(OE_DEVICE_ID_LIGHTGUN_START, "Start");
//                    AddButton(OE_DEVICE_ID_LIGHTGUN_SELECT, "Select");
//                    AddButton(OE_DEVICE_ID_LIGHTGUN_AUX_C, "C");
//                    AddButton(OE_DEVICE_ID_LIGHTGUN_DPAD_UP, "Up");
//                    AddButton(OE_DEVICE_ID_LIGHTGUN_DPAD_DOWN, "Down");
//                    AddButton(OE_DEVICE_ID_LIGHTGUN_DPAD_LEFT, "Left");
//                    AddButton(OE_DEVICE_ID_LIGHTGUN_DPAD_RIGHT, "Right");
//                    return;
//            }
//        }
//
//        static void AddDevicesForPort(unsigned port)
//        {
//            g_controller_interface.AddDevice(std::make_shared<Device>(OE_DEVICE_JOYPAD, port));
//            g_controller_interface.AddDevice(std::make_shared<Device>(OE_DEVICE_ANALOG, port));
//            g_controller_interface.AddDevice(std::make_shared<Device>(OE_DEVICE_POINTER, port));
//        }
//
//        static void RemoveDevicesForPort(unsigned port)
//        {
//            g_controller_interface.RemoveDevice([&port](const auto& device) {
//                return device->GetSource() == source
//                && (device->GetName() == GetDeviceName(OE_DEVICE_ANALOG)
//                    || device->GetName() == GetDeviceName(OE_DEVICE_JOYPAD)
//                    || device->GetName() == GetDeviceName(OE_DEVICE_POINTER))
//                && dynamic_cast<const Device *>(device)->GetPort() == port;
//            });
//        }
//
//        void Init()
//        {
//            //environ_cb(OE_ENVIRONMENT_GET_RUMBLE_INTERFACE, &rumble);
//
//            g_controller_interface.Initialize(DolHost::GetInstance()->GetWSI());
//
//            g_controller_interface.AddDevice(std::make_shared<Device>(OE_DEVICE_KEYBOARD, 0));
//
//            Pad::Initialize();
//            Keyboard::Initialize();
//
...
//                Wiimote::Initialize(Wiimote::InitializeMode::DO_NOT_WAIT_FOR_WIIMOTES);
//
//                static const struct OE_controller_description wiimote_desc[] = {
//                    {"WiiMote", OE_DEVICE_WIIMOTE},
//                    {"WiiMote (sideways)", OE_DEVICE_WIIMOTE_SW},
//                    {"WiiMote + Nunchuk", OE_DEVICE_WIIMOTE_NC},
//                    {"WiiMote + Classic Controller", OE_DEVICE_WIIMOTE_CC},
//                    {"Real WiiMote", OE_DEVICE_REAL_WIIMOTE},
//                };
//
//                static const struct OE_controller_info ports[] = {
//                    {wiimote_desc, sizeof(wiimote_desc) / sizeof(*wiimote_desc)},
//                    {wiimote_desc, sizeof(wiimote_desc) / sizeof(*wiimote_desc)},
//                    {wiimote_desc, sizeof(wiimote_desc) / sizeof(*wiimote_desc)},
//                    {wiimote_desc, sizeof(wiimote_desc) / sizeof(*wiimote_desc)},
...
//                };
//
//                //environ_cb(OE_ENVIRONMENT_SET_CONTROLLER_INFO, (void*)ports);
//            }
//            else
//            {
//                static const struct OE_controller_description gcpad_desc[] = {
//                    {"GameCube Controller", OE_DEVICE_JOYPAD},
//                };
//
//                static const struct OE_controller_info ports[] = {
//                    {gcpad_desc, sizeof(gcpad_desc) / sizeof(*gcpad_desc)},
...
//        {
//            for (int port = 0; port < 4; port++)
//                OE_set_controller_port_device(port, input_types[port]);
//        }
//
//    }  // namespace Input
//}  // namespace OPENEMUCORE
//
////void OE_set_input_poll(OE_input_poll_t cb)
////{
////    OPENEMUCORE::Input::poll_cb = cb;
////}
////
//
//void OE_set_input_state(OE_input_state_t cb)
//{
//   OPENEMUCORE::Input::input_cb = cb;
//}
//
...
//        return;
//
//    OPENEMUCORE::Input::input_types[port] = device;
//
//    std::string devJoypad = OPENEMUCORE::Input::GetQualifiedName(port, OE_DEVICE_JOYPAD);
//    std::string devAnalog = OPENEMUCORE::Input::GetQualifiedName(port, OE_DEVICE_ANALOG);
//    std::string devPointer = OPENEMUCORE::Input::GetQualifiedName(port, OE_DEVICE_POINTER);
//#if 0
//    std::string devMouse = OPENEMUCORE::Input::GetQualifiedName(port, OE_DEVICE_MOUSE);
//    std::string devKeyboard = OPENEMUCORE::Input::GetQualifiedName(port, OE_DEVICE_KEYBOARD);
//    std::string devLightgun = OPENEMUCORE::Input::GetQualifiedName(port, OE_DEVICE_LIGHTGUN);
//#endif
//
//    OPENEMUCORE::Input::RemoveDevicesForPort(port);
//    if ((device & 0xff) != OE_DEVICE_NONE)
//        OPENEMUCORE::Input::AddDevicesForPort(port);
//
//    if (!SConfig::GetInstance().bWii)
//    {
//        GCPad* gcPad = (GCPad*)Pad::GetConfig()->GetController(port);
...
//        Pad::GetConfig()->SaveConfig();
//    }
//    else if (!SConfig::GetInstance().m_bt_passthrough_enabled && (device & 0xff) != OE_DEVICE_NONE)
//    {
//        WiimoteEmu::Wiimote* wm = (WiimoteEmu::Wiimote*)Wiimote::GetConfig()->GetController(port);
//        // load an empty inifile section, clears everything
//        IniFile::Section sec;
...
//
//        using namespace WiimoteEmu;
//        if (device == OE_DEVICE_WIIMOTE_CC)
//        {
//            ControllerEmu::ControlGroup* ccButtons = wm->GetClassicGroup(ClassicGroup::Buttons);
//            ControllerEmu::ControlGroup* ccTriggers = wm->GetClassicGroup(ClassicGroup::Triggers);
//            ControllerEmu::ControlGroup* ccDpad = wm->GetClassicGroup(ClassicGroup::DPad);
...
//            ccLeftStick->SetControlExpression(3, "`" + devAnalog + ":X0+`");      // Right
//
////            if (OPENEMUCORE::Options::irMode != 1 && OPENEMUCORE::Options::irMode != 2)
////            {
////                ccRightStick->SetControlExpression(0, "`" + devAnalog + ":Y1-`");     // Up
////                ccRightStick->SetControlExpression(1, "`" + devAnalog + ":Y1+`");     // Down
////                ccRightStick->SetControlExpression(2, "`" + devAnalog + ":X1-`");     // Left
...
//            wmButtons->SetControlExpression(0, "A | `" + devPointer + ":Pressed0`");  // A
//            wmButtons->SetControlExpression(1, "B");                                  // B
////            wmIR->numeric_settings[0]->SetValue(OPENEMUCORE::Options::irCenter / 100.0); // IR Center
////            wmIR->numeric_settings[1]->SetValue(OPENEMUCORE::Options::irWidth / 100.0);  // IR Width
////            wmIR->numeric_settings[2]->SetValue(OPENEMUCORE::Options::irHeight / 100.0); // IR Height
//
//            if (device == OE_DEVICE_WIIMOTE_NC)
//            {
//                ControllerEmu::ControlGroup* ncButtons = wm->GetNunchukGroup(NunchukGroup::Buttons);
//                ControllerEmu::ControlGroup* ncStick = wm->GetNunchukGroup(NunchukGroup::Stick);
//                ControllerEmu::ControlGroup* ncShake = wm->GetNunchukGroup(NunchukGroup::Shake);
...
////                wmIR->SetControlExpression(2, "`" + devAnalog + ":X1-`");     // Left
////                wmIR->SetControlExpression(3, "`" + devAnalog + ":X1+`");     // Right
////                wmIR->boolean_settings[0]->SetValue(OPENEMUCORE::Options::irMode == 1); // Relative input
////                wmIR->boolean_settings[1]->SetValue(true);                    // Auto hide
////            }
////            else
//            {
...
//        switch (device)
//        {
//            case OE_DEVICE_WIIMOTE:
//               // wmExtension->switch_extension = EXT_NONE;
//                WiimoteReal::ChangeWiimoteSource(port, WIIMOTE_SRC_EMU);
//                break;
//
//            case OE_DEVICE_WIIMOTE_SW:
//                //wmExtension->switch_extension = EXT_NONE;
//                wmOptions->boolean_settings[2]->SetValue(true);  // Sideways Wiimote
//                WiimoteReal::ChangeWiimoteSource(port, WIIMOTE_SRC_EMU);
//                break;
//
//            case OE_DEVICE_WIIMOTE_NC:
//                //wmExtension->switch_extension = EXT_NUNCHUK;
//                WiimoteReal::ChangeWiimoteSource(port, WIIMOTE_SRC_EMU);
//                break;
//
//            case OE_DEVICE_WIIMOTE_CC:
//                //wmExtension->switch_extension = EXT_CLASSIC;
//                WiimoteReal::ChangeWiimoteSource(port, WIIMOTE_SRC_EMU);
//                break;
//
...
//        ::Wiimote::GetConfig()->SaveConfig();
//    }
//    else if (OPENEMUCORE::Input::input_types[port] == OE_DEVICE_REAL_WIIMOTE)
//        WiimoteReal::ChangeWiimoteSource(port, WIIMOTE_SRC_REAL);
//
//    std::vector<OE_input_descriptor> all_descs;
//
//    for (int i = 0; i < 4; i++)
//    {
//        OE_input_descriptor* desc;
//
//        switch (OPENEMUCORE::Input::input_types[i])
//        {
//            case OE_DEVICE_WIIMOTE:
//                desc = OPENEMUCORE::Input::descWiimote;
//                break;
//
//            case OE_DEVICE_WIIMOTE_SW:
//                desc = OPENEMUCORE::Input::descWiimoteSideways;
//                break;
//
//            case OE_DEVICE_WIIMOTE_NC:
//                desc = OPENEMUCORE::Input::descWiimoteNunchuk;
//                break;
//
//            case OE_DEVICE_WIIMOTE_CC:
//                desc = OPENEMUCORE::Input::descWiimoteCC;
//                break;
//
//            case OE_DEVICE_REAL_WIIMOTE:
//            case OE_DEVICE_NONE:
//                continue;
//
//            default:
//                desc = OPENEMUCORE::Input::descGC;
//                break;
//        }
//        for (int j = 0; desc[j].device != 0; j++)
//        {
//            OE_input_descriptor new_desc = desc[j];
//            new_desc.port = i;
//            all_descs.push_back(new_desc);
//        }
//    }
//    all_descs.push_back({ 0 });
//    //OPENEMUCORE::environ_cb(OE_ENVIRONMENT_SET_INPUT_DESCRIPTORS, &all_descs[0]);
//}
